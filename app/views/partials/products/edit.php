                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="weigth">Weigth <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-weigth"  value="<?php  echo $data['weigth']; ?>" type="number" placeholder="Enter Weigth" step="1"  required="" name="weigth"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="categories_id">Categories Id <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-categories_id"  value="<?php  echo $data['categories_id']; ?>" type="number" placeholder="Enter Categories Id" step="1"  required="" name="categories_id"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
