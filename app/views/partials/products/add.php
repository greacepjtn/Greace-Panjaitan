                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-weigth"  value="<?php  echo $this->set_field_value('weigth',""); ?>" type="number" placeholder="Enter Weigth" step="1"  required="" name="weigth"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-categories_id"  value="<?php  echo $this->set_field_value('categories_id',""); ?>" type="number" placeholder="Enter Categories Id" step="1"  required="" name="categories_id"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-stok"  value="<?php  echo $this->set_field_value('stok',"0"); ?>" type="number" placeholder="Enter Stok" step="1"  required="" name="stok"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
