                        ...
                        <form id="alamat-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("alamat/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="cities_id">Cities Id <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-cities_id"  value="<?php  echo $this->set_field_value('cities_id',""); ?>" type="number" placeholder="Enter Cities Id" step="1"  required="" name="cities_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
