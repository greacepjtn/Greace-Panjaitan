                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-products_id"  value="<?php  echo $data['products_id']; ?>" type="number" placeholder="Enter Products Id" step="1"  required="" name="products_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
